...
- **마음 챙기기**: 핵심 고민 상황에서 스스로의 마음을 다스리고 감정을 조절하는 구체적 방법
...
3. **각 솔루션은 최대 25자 이내**로 간결하게 작성 (2줄을 넘지 않는 길이)
4. **핵심 고민을 직접적으로 해결하는** 구체적 행동 계획 제시
5. **선택된 강점을 핵심 고민 해결에 활용**하는 방법 포함
6. **선택된 해결방안 카테고리를 핵심 고민에 적용**한 구체적 실행법
7. **${characterName}의 상황, 성격, 환경에 맞는** 개인화된 조언
8. **언제, 어디서, 어떻게** 할지 구체적으로 명시하되 간결하게 표현
...
각 솔루션은 ${characterName}이 바로 실행할 수 있는 구체적인 행동 계획이어야 하며, 핵심 고민을 직접적으로 해결하는 내용이어야 하고, 반드시 '~하기' 형태로 끝나야 합니다. 솔루션은 최대 25자 이내로 간결하게 작성해주세요.`;
